...
export default function OrderTableForManualPay({
  ...
  const havePartialPayins = selectedItems.some((item) => 'has_partial_payins' in item && item.has_partial_payins);
  return (
    <>
      <>
        <Tabs
        ...
        >
          ...
          >
            <TabList>
              ...
              {isConceptActive ? (
                <TabTrigger value="optionals" disabled={havePartialPayins}>
