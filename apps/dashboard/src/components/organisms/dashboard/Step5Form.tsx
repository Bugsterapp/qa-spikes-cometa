              ...
              render={({ field: { onChange, value } }) => (
                <RadioGroup onValueChange={onChange} defaultValue={value}>
                  <span className="text-base font-semibold">
                    ¿Las facturas de este concepto deben incluir complemento educativo?{' '}
                    <span className="italic font-thin text-[#637381]">(RVOE)</span>
                  </span>
                  <div className="flex flex-row mt-3">
                    <div className="flex items-center ml-2 mr-6 space-x-2">
  ...
  return items && items.length > 0 ? (
    <div>
      <div className="relative flex flex-col w-full gap-1">
        <div className="flex rounded-lg px-4 py-2 border border-[#C0C9D8] bg-white gap-0.5 focus-within:ring-green focus-within:hover:ring-green focus-within:ring-[1.5px] justify-between items-center">
      ...
      <ul
        className={`absolute shadow-lg max-w-[500px] w-full rounded-md bg-white mt-1 max-h-72 overflow-scroll p-0 z-10 ${
          !isOpen && 'hidden'
        }`}
        {...getMenuProps()}
      >
