...
import { DashboardFulfillmentList } from '@cometa/trpc/src/types';
                ...
                <div id="fulfillments" className="mt-8">
                  ...
                  <div className="mt-6 mb-6 border rounded-lg border-info border-opacity-[0.9]">
                    {!isLoading &&
                      ...
                      incomePayin?.fulfillments?.map((fulfillment) => (
                        <FulfillmentPayout
                          key={fulfillment.id}
...
const FulfillmentPayout = ({
  ...
  fulfillment: DashboardFulfillmentList;
      ...
      <div className="flex items-center col-span-3">
        ...
        <div className="flex items-center pl-2">
          ...
          <InvoiceChip intent={invoiceStatus[fulfillment?.invoice_status as keyof typeof invoiceStatus]}>
            {invoiceStatusI18N[fulfillment?.invoice_status as keyof typeof invoiceStatus]?.invoice_status}
          </InvoiceChip>
        </div>
      </div>
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex flex-row items-center justify-between">
            ...
            <label className="text-sm font-semibold">
              {formatPrice(fulfillment?.has_partial_payins ? total : fulfillment?.final_amount, 'MXN')}
            </label>
          </div>
        </div>
      </div>
