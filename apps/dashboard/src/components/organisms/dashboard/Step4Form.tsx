      ...
      <div className="min-h-[82vh]">
        ...
        <div className="flex w-full flex-col">
          {discountItems.map((item, i) => (
            <div
              className="py-4 border border-gray-300 rounded-md flex w-full justify-between px-4 mb-4"
              key={i + Math.random()}
            >
              <div className="grid grid-cols-4 gap-4">
                <div className="flex flex-col col-span-1 items-center">
                  <p className="text-gray text-xs">Valor de dscto</p>
                  <p className="p-1 text-xs font-bold bg-[#54D62C29] text-green rounded-md w-fit px-3">
                    {item.discount_value} {item.discount_type === 'AMOUNT' ? 'MXN' : '%'}
                  </p>
                </div>
                <div className="col-span-3">
                  <p className="text-gray text-xs">Vigencia del descuento</p>
                  <p className="p-1 text-xs font-medium">
                    Hasta{' '}
                    {needPicker ? (
                      ...
                      <span className="font-normal text-[#919EAB]">
          ...
          <form id="discount_form" onSubmit={formDiscountStep.handleSubmit(onSaveDiscount)}>
            <div className="p-4 border-2 rounded-lg z-30">
              ...
              <div className="flex items-center mt-6">
                ...
                />
                <span className="mt-1 ml-4">El descuento aplicará hasta el mismo día de vencimiento</span>
              </div>
              <div className="mt-8">
                <Controller
                  control={formDiscountStep.control}
                  ...
                  render={({ field: { onChange, value } }) => (
                    <RadioGroup
                      ...
                      value={value}
                      error={formDiscountStep.formState.errors?.discount_type?.message}
                    >
              ...
              <div className="pt-10 flex bg-white">
                <button
                  ...
                  onClick={() => setShowCreateDiscounts(false)}
                  type="button"
                >
                  Cancelar
                </button>
