...
>(({ className, ...props }, ref) => (
  <div className="flex items-center px-3 m-2 rounded-lg bg-[#F3F6FB]" cmdk-input-wrapper="">
    <Search className="h-4 w-4 shrink-0 opacity-50" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'flex w-full rounded-lg text-sm outline-none px-[10px] focus:ring-transparent placeholder:text-[#B4B8C6] disabled:cursor-not-allowed disabled:opacity-50',
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={cn(
      'overflow-hidden p-2 text-gray-950 [&_[cmdk-group-heading]]:px-3 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-gray-500',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none rounded-lg my-1 text-sm outline-none aria-selected:text-gray-900',
      className
    )}
    {...props}
  />
