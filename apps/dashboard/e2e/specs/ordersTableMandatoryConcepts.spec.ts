...
import { addOrdersToStudent, createMandatoryConceptByApi, deleteConceptByApi } from '../../../e2e/helpers/concepts';
import { user1 } from '../../../e2e/data/data';

import { SchoolCycle } from '@cometa/trpc/src/types';
import { ConceptDetailPage } from '../../../e2e/pages/conceptDetailPage';
...
async function registerPayment(
  ...
  await incomePage.page.getByTestId('registerpayment-button').click();
