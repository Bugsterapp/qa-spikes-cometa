...
export const BranchPrevious = ({ className, children, ...props }: BranchPreviousProps) => {
  ...
  return (
    <Button
      ...
      className={cn(
        'size-7 shrink-0 rounded-full text-gray-500 transition-colors dark:text-gray-400',
        'hover:bg-gray-100 hover:text-foreground dark:hover:bg-gray-800',
...
export const BranchPage = ({ className, ...props }: BranchPageProps) => {
  ...
  return (
    <span className={cn('font-medium text-gray-500 text-xs tabular-nums dark:text-gray-400', className)} {...props}>
