...
const FormFieldsBilling = ({ formik, disabledAll = false }: { formik: FormikProps<any>; disabledAll?: boolean }) => {
  const [showBillingNameHelperText, setShowBillingNameHelperText] = useState(false);
          ...
          <div className="mb-3">
            ...
            >
              <CustomInput
                ...
                disabled={disabledAll}
                onFocus={() => {
                  if (formik.values.personType !== personTypeDefault) setShowBillingNameHelperText(true);
                }}
                className={cn(
