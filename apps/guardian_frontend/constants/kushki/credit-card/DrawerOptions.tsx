...
const DrawerOptions = {
  ...
  stock: {
    icon: <InformationWhite className="text-white fill-current" />,
    title: 'Algunos conceptos a pagar ya no tienen stock disponible.',
    optionMessage:
      'Si crees que este error ha salido por equivocación puedes contactar a nuestro equipo se soporte y te ayudaremos lo antes posible.',
    code: 'error',
  },
};
