...
export class IncomePage {
  ...
  readonly payoutsDownloadBtn: Locator;
  readonly payoutTableReportBtn: Locator;
  ...
  constructor(page: Page) {
    ...
    this.paymentAccountComboBoxOption = page.getByLabel('BANORTE (Account School GVS 1)');
    ...
    this.payoutsDownloadBtn = page.getByTestId('download-button');
    this.payoutTableReportBtn = page.getByTestId('table-report-button');
  }
}
